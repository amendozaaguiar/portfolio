                        ...
                        <div className="box has-text-centered">
                            <div className="columns is-centered">
                                <div className="column mt-6 mb-6 skill-column">
                                    <FontAwesomeIcon icon={faLaptopCode} className="has-text-dark icon-skills" />
                                    ...
                                    <h5 className="is-size-5 mt-6 has-text-dark has-text-weight-semibold">Lenguajes y frameworks que empleo:</h5>
                                    <p className="mt-4">PHP, Laravel, Livewire, MySql</p>
                                    <h5 className="is-size-5 mt-6 has-text-dark has-text-weight-semibold">Experiencia:</h5>
                                    <ul>
                                ...
                                <div className="column mt-6 mb-6 skill-column">
                                    <FontAwesomeIcon icon={faLaptop} className="has-text-dark icon-skills" />
                                    ...
                                    <h5 className="is-size-5 mt-6 has-text-dark has-text-weight-semibold">Lenguajes y librerias que empleo:</h5>
                                ...
                                <div className="column mt-6 mb-6">
                                    <FontAwesomeIcon icon={faCodeBranch} className="has-text-dark icon-skills" />
                                    ...
                                    <h5 className="is-size-5 mt-6 has-text-dark has-text-weight-semibold">Experiencia en:</h5>
